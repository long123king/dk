...
// This file comes from: https://github.com/commial/ttd-bindings/blob/master/TTD/TTD.hpp
// With several trivial modifications.
...
namespace TTD {
	...
	*/
	...
	typedef struct TTD_Replay_ICursor_vftable {
		...
		//void* unk31;
		void (__stdcall* SetReplayFlags)(TTD_Replay_ICursor* self, uint32_t replayFlags);
	...
	*/
	...
	typedef struct TTD_Replay_IThreadView_vftable {
		...
		//void* unk4;
		Position* (*GetPreviousPosition)(TTD_Replay_IThreadView* self);
		GuestAddress (*GetProgramCounter)(TTD_Replay_IThreadView* self);
		// TTD::Replay::ExecutionState::GetStackPointer(void)
		//void* unk6;
		
		GuestAddress(*GetStackPointer)(TTD_Replay_IThreadView* self);
		// TTD::Replay::ExecutionState::GetFramePointer(void)
		//void* unk7;
		GuestAddress(*GetFramePointer)(TTD_Replay_IThreadView* self);
